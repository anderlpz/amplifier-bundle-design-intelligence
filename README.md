...
- **Behavior pattern** - `behaviors/design-intelligence.yaml` can be included independently
- **Consolidated instructions** - Single source of truth in `context/design-instructions.md`
- **Minimal bundle.md** - Just includes and context references
...
- **foundation** bundle - Inherited via `includes:` in bundle.md (provides tools, session, hooks)
