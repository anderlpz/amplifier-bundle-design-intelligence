...
- `@design-intelligence:context/archive-index.md` - 30-day rolling summary (always loaded)
...
- Monthly summaries: `@design-intelligence:archive/YYYY/MM-month/summary.md`
- Raw project data: `@design-intelligence:archive/YYYY/MM-month/raw/*.json`
- Visual references: `@design-intelligence:archive/YYYY/MM-month/images/*.png`
...
[Load @design-intelligence:archive/2026/01-january/summary.md]
...
[Load @design-intelligence:archive/2026/01-january/raw/awwwards-2026-01-12.json]
```
