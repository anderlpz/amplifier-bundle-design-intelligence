...
```
execute design-intelligence-enhanced:recipes/weekly-design-scrape.yaml with year=2026 month=01 month_name=january date=2026-01-13
```
...
- **Research Runner Agent:** `@design-intelligence-enhanced:agents/research-runner.md`
- **Research Analyst Agent:** `@design-intelligence-enhanced:agents/research-analyst.md`
- **Weekly Scrape Recipe:** `@design-intelligence-enhanced:recipes/weekly-design-scrape.yaml`
- **Archive Index:** `@design-intelligence-enhanced:context/archive-index.md`
